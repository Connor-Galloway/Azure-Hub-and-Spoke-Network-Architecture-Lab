...
This diagram illustrates the hub-and-spoke network topology deployed in Microsoft Azure. It details the relationship between the three VNets, the centralized security components housed in the hub, and the workloads running in each spoke.
